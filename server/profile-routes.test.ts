...
function authenticatedContext(): TrpcContext {
  return {
    user: { id: "user-1", email: "owner@example.com", name: "陈晨", role: "member", createdAt: new Date(), updatedAt: new Date(), lastSignedInAt: null },
    req: {} as never,
    res: {} as never,
  };
}
...
describe("profile update routes", () => {
  ...
  it("saves shop identity fields and the private logo asset with the authenticated workspace owner", async () => {
    ...
    await expect(caller.workspace.updateProfile({ workspaceId: "b312ce34-410b-49e9-a81f-0971fd9846d8", name: "晨光零售", industryId: "retail", contactName: "陈晨", logoAssetId: "d356f4c6-5832-4ce4-b3ea-9ff59a722dd0" })).resolves.toMatchObject({ role: "owner" });
    expect(dbMocks.updateWorkspaceProfile).toHaveBeenCalledWith({ workspaceId: "b312ce34-410b-49e9-a81f-0971fd9846d8", userId: "user-1", name: "晨光零售", industryId: "retail", contactName: "陈晨", logoAssetId: "d356f4c6-5832-4ce4-b3ea-9ff59a722dd0" });
  });
});
